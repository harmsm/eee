...
class EvolutionResultsContainer:
    """
    Containiner class with attributes holding results of the simulation. 
    """
...
def write_fisher(ens,
    ...
    return EvolutionResultsContainer(genotypes=genotypes,
