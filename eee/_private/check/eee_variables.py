...
def check_calc_params(T=None,
    ...
    if population_size is not None:
        population_size = check_int(value=population_size,
    ...
    if mutation_rate is not None:
        mutation_rate = check_float(value=mutation_rate,
    ...
    if num_generations is not None:
        num_generations = check_int(value=num_generations,
    ...
    if burn_in_generations is not None:
        burn_in_generations = check_int(value=burn_in_generations,
